...
const CustomLabel = ({ cx, cy, midAngle, innerRadius, outerRadius, percent }: any) => {
  ...
  // Fix: Check if percent is defined and greater than 0.05 (5%)
  if (!percent || percent < 0.05) return null; // Don't show label for small or undefined slices
...
const PremiumPieChart: React.FC<PieChartProps> = ({
  data,
