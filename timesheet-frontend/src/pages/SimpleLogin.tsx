...
const SimpleLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 flex items-center justify-center p-6 overflow-hidden relative">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Login Card */}
        <Card className="p-8 shadow-2xl bg-white/95 backdrop-blur-3xl">
