...
const AdminDashboard: React.FC = () => {
  ...
  const adminQuickLinks = [
    ...
    { name: 'Admin Panel', color: 'text-red-600', bg: 'bg-red-50', link: '/admin', icon: Cog6ToothIcon },
    { name: 'Jobs', color: 'text-orange-600', bg: 'bg-orange-50', link: '/jobs', icon: WrenchScrewdriverIcon },
  ...
  return (
    <div className="space-y-6 animate-fade-in max-h-[calc(100vh-120px)] overflow-hidden flex flex-col">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 flex-none">
        <div>
          <h1 className="text-3xl font-extrabold text-secondary-900 tracking-tight">Admin Dashboard</h1>
          <p className="text-sm font-medium text-secondary-500 mt-1">
            Welcome back, {user?.name || 'Admin'}! Complete system overview and administrative controls.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1 min-h-0 overflow-hidden">
            ...
            <div className="lg:col-span-8 flex flex-col min-h-0">
              <Card className="flex flex-col h-full overflow-hidden">
                <div className="px-6 py-4 border-b border-secondary-100 flex items-center justify-between bg-white whitespace-nowrap">
                  <h3 className="text-lg font-bold text-secondary-900 tracking-tight">System Activity Feed</h3>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                  {recentActivities.length > 0 ? (
                    ...
                    <div className="p-10 text-center text-secondary-400 font-bold text-sm">
                      No system activity found. The system is ready for operations.
                    </div>
                  )}
                </div>
                <div className="p-4 bg-secondary-50/50 border-t border-secondary-100 text-center flex-none">
                  <p className="text-[10px] font-bold text-secondary-400 uppercase tracking-widest italic tracking-widest">System monitoring active <span className="text-success-500 mx-2">●</span> {new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
                </div>
              </Card>
            </div>
            ...
            <div className="lg:col-span-4 flex flex-col gap-6 overflow-y-auto no-scrollbar pb-10">
              <Card className="p-6 space-y-6">
                <h3 className="text-lg font-bold text-secondary-900 tracking-tight mb-2">Admin Controls</h3>
              ...
              <Card className="p-6 bg-gradient-to-br from-red-600 to-orange-700 border-none shadow-elevated group relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-xl font-bold text-white tracking-tight">System Administration</h3>
                    <p className="text-sm font-medium text-white/80 leading-relaxed italic opacity-80 pt-1">
                      Full administrative control over the entire system, user management, and configuration.
                    </p>
                  </div>
                  <Button variant="primary" fullWidth className="bg-white text-red-600 border-none h-12 text-sm font-bold font-extrabold shadow-none hover:bg-white/90">
                    Access Admin Panel
                  </Button>
                </div>
              </Card>
